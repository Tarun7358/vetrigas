 ...
 * Usage: node run_mock_simulator.js [http://localhost:5000 | https://vetrigas.onrender.com]
 */

const http = require('http');
const https = require('https');

const TARGET_BASE = process.argv[2] || 'http://localhost:5000';
console.log(`\n======================================================`);
...
setInterval(async () => {
  ...
  if (res.success) {
    ...
    console.log(`[GPS TICK #${gpsTickCount}] Attempted GPS update (Server status: ${res.error || 'waiting...'})`);
  }
}, 2500);
